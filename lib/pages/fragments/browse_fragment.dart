...
import 'package:rent_motor/controllers/browse_newest_controller.dart';
import 'package:rent_motor/controllers/browse_status_controller.dart';
...
class _BrowseFragmentState extends State<BrowseFragment> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      //   'name': 'Moto 2 Cross',
      //   'image':
      //       'https://firebasestorage.googleapis.com/v0/b/course-motobike-64406.appspot.com/o/bike%2Frideriama_pro.png?alt=media&token=a9f684fa-de5b-4538-95af-c5f132da741d',
      // };
    });
    super.initState();
  }
            ...
            Row(
              children: [
                ...
                RatingBar.builder(
                    ...
                    itemPadding: const EdgeInsetsDirectional.all(0),
                    itemSize: 16,
